...
export default async function ContentCard({
  ...
  return (
    <>
      <div className="bg-primary min-h-screen w-9/12 min-w-72 flex flex-col justify-center items-center mt-7 rounded overflow-hidden max-[1050px]:flex-col">
        <aside className="w-full p-4 flex flex-col justify-start items-start gap-5">
        ...
        content.tipo_de_midia === "video" ? (
          <iframe
            ...
            src={content.link}
            className={
              "w-2/4 max-[1050px]:w-full min-w-full min-h-screen flex justify-center items-center"
            }
          />
        ) : (
          <img
