...
export default function Header() {
  ...
  return (
    <header
      className={`w-full bg-primary flex flex-col px-3 shadow-lg sticky top-0 z-10 ${pacifico.className}`}
    >
      <main className="w-full max-sm:h-24 sm:h-16 px-2 flex justify-around items-center">
        ...
        <div className="flex flex-1 justify-end gap-4">
          ...
          <a href="https://whatsapp.com" className="flex justify-center items-center">
      ...
      <nav
        className={`w-full bg-primary flex justify-between items-center px-6 h-12 sticky top-0 z-10 ${ubuntu.className}`}
      >
        <Link
          href={"/"}
