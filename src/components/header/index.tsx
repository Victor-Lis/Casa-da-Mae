    ...
    >
      ...
      >
        ...
        <Link
          href={"/casadamae"}
          className={`text-lg text-white my-2 ${
            isLikeRoute("/casadamae") ? "font-bold underline" : ""
          }`}
        >
          Casa da Mãe
        </Link>
        <Link
          href={"/projeto"}
          className={`text-lg text-white my-2 ${
            isLikeRoute("/projeto") ? "font-bold underline" : ""
          }`}
        >
          Projeto
        </Link>
        <Link
          href={"/cursos"}
          className={`text-lg text-white my-2 ${
            isLikeRoute("/cursos") ? "font-bold underline" : ""
          }`}
        >
          Cursos
        </Link>
        <Link
          href={"/artigosecronicas"}
          className={`text-lg text-white my-2 ${
            isLikeRoute("/artigosecronicas") ? "font-bold underline" : ""
          }`}
        >
          Artigos e Crônicas
        </Link>
        <Link
          href={"/investidores"}
          className={`text-lg text-white my-2 ${
            isLikeRoute("/investidores") ? "font-bold underline" : ""
          }`}
        >
          Investidores
        </Link>
        ...
        <Link
          href={"/imagens"}
          className={`text-lg text-white my-2 ${
            isLikeRoute("/imagens") ? "font-bold underline" : ""
          }`}
        >
          Fotos/Vídeos
        </Link>
        <Link
          href={"/arearestrita"}
          className={`text-lg text-white my-2 ${
            isLikeRoute("/arearestrita") ? "font-bold underline" : ""
          }`}
        >
          Área Restrita
        </Link>
